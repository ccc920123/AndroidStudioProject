...
public class SharedPreferencesUtils {
	...
	public static void setBoolean(CommonBaseActivity mActivity, String key,
			boolean value) {
		SharedPreferences sp = mActivity.getSharedPreferences("config",
				Context.MODE_PRIVATE);
		Editor edit = sp.edit();
	...
	public static boolean isFirst(CommonBaseActivity mActivity) {
	...
	public static void saveHeight(CommonBaseActivity mActivity, int height) {
		SharedPreferences sp = mActivity.getSharedPreferences("config",
				Context.MODE_PRIVATE);
		Editor edit = sp.edit();
	...
	public static int getHeight(CommonBaseActivity mActivity) {
		SharedPreferences sp = mActivity.getSharedPreferences("config",
				Context.MODE_PRIVATE);
